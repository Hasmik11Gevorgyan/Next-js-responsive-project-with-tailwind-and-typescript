...
const Hero = () => {
  return (
    <div className="relative w-full h-[110vh] flex justify-center flex-col sm:h-screen bg-[url('/images/bg.png')] bg-cover bg-center underline">
      <div className="w-[90%] md:w-[80%] mx-auto items-center grid grid-cols-1 xl:grid-cols-2 gap-10 ">
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm md:text-base font-medium text-grey-700">
            {" "}
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed quaerat
            eligendi possimus adipisci, sit eius, corrupti harum voluptatem
            veritatis, a eos! Assumenda nisi obcaecati dolores placeat unde
            earum voluptas doloribus.
          </p>
          {/*ratings*/}
          ...
          <div className="mt-8 flex flex-col sm:flex-row w-fit sm:items-center space-y-4 sm:space-y-0 sm:space-x-4">
            <a
              href="#_"
              className="relative px-10 py-3 font-medium text-white transition duration-300 bg-rose-700 rounded-md hover:bg-rose-500 ease no-underline"
            >
              ...
              <span className="relative text-xl">Get Free Trial</span>
            </a>
            <a
              href="#_"
              className="relative px-10 py-3 font-medium text-white transition duration-300 bg-green-400 rounded-md hover:bg-green-500 ease no-underline"
            >
              <span className="absolute bottom-0 left-0 h-full -ml-2">
                <svg
                  viewBox="0 0 487 487"
              ...
              <span className="relative text-xl">Create Account</span>
            </a>
          </div>
        </div>
